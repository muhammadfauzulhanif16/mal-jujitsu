...
import { ActionIcon, Avatar, Button, Divider, Fieldset, FileButton, Grid, Group, Indicator, NumberInput, Radio, Stack, TextInput, Tooltip } from '@mantine/core'
...
const Edit = (props) => {
  ...
  return (
    <form onSubmit={(e) => {
      ...
      <AppLayout title="Profil" authed={props.auth.user} meta={props.meta} unreadHistories={props.unread_histories.length}>
